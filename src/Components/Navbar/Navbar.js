...
export default function Navbar(props) {
    const [isFilterVisible, settoggleFilter] = useState(false);

    function toggleFilterVisibility(e){
        settoggleFilter(!isFilterVisible);
        if(e.target.value !== undefined){
            props.handleGroupValue(e.target.value);
        }
    }
    function changeOrderingValue(e){
        settoggleFilter(!isFilterVisible);
        if(e.target.value !== undefined){
    ...
    <>
        <section className="nav">
            <div className="nav-container">
                <div>
                    <div className="nav-disp-btn" onClick={toggleFilterVisibility}>
                    ...
                    <div className={isFilterVisible ? "nav-disp-dropdown nav-disp-dropdown-show" : "nav-disp-dropdown"}>
                        <div className="nav-disp-filters">
                            ...
                            <div className="nav-dropdown-selector">
                                <select value={props.newValue} onChange={toggleFilterVisibility} className='nav-selector' name="grouping" id="">
                        ...
                        <div className="nav-disp-filters">
                            ...
                            <div className="nav-dropdown-selector">
                                <select value={props.orderValue} onChange={changeOrderingValue} className='nav-selector' name="grouping" id="">
                                    <option value="priority">Priority</option>
